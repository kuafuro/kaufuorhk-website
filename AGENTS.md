...
**Start here:** `PRODUCT.md` — especially **Project overview (專案概覽)** for architecture,
site map, roles, and backend inventory. Then read **Register / Users / principles** in the same
file, and `DESIGN.md` (visual tokens, components) before changing any user-facing UI.
...
1. Branch off `main`: `cursor/<descriptive-name>-74f8` (lowercase).
